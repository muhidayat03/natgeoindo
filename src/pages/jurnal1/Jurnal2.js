...
const Jurnal1 = () => {
  ...
  useEffect(() => {
    ...
    let a = document.getElementById('testiing');
    // a.click();
  ...
  return <>
    {loading}
    <div  id='testing' onClick={() => console.log('slooooo;;;;;;;')}>testing</div>
    <Player url={audio} />
    <ScrollingProvider>
      <div >
        <div>
        ...
        <Section id="sejarah" className='wave-cwontainer'>
          <Container2 >
              ...
              <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
                <ContentContainer style={{ backgroundColor: 'rgba(251, 252, 254, .05) ', padding: '40px 20px', }}>
                  ...
                  <div style={{ marginTop: 40 }}  >
                    <p style={{ fontWeight: 'bold', fontSize: 24 }} data-aos="flip-down">
